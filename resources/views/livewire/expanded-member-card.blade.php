<div class="grid grid-cols-12 {{ ($hasIssues) ? 'bg-yellow-200' : 'bg-blue-300' }} m-1 pl-2 pr-1 pt-2 h-72 rounded-full {{ ($isStaff) ? 'hidden' : '' }}">
    <div class="font-bold col-start-3 col-span-8 mt-2">
        <x-jet-input type="text" class="discord_name p-0 m-0 w-full border-none" title="Member's discord name" value="{{ $memberName }}"/>
    </div>
    <div class=" col-start-3 col-span-8 mt-2">
